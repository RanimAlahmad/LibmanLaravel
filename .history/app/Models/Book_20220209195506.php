...
class Book extends BaseModel
{
    ...
    public function allBook(){
        return  DB::table('book_categories','book')
        ->join('books', 'books.id', '=', 'book_categories.book_id')
        ->join('categories', 'categories.id', '=', 'book_categories.categorie_id')
        ->select('books.id', 'books.name', 'books.picture', 'categories.name')
        ->get();
    }
