...
class Book extends BaseModel
{
    ...
    public function allBook(){
        return  $this->select('id','name','picture','price')
        ->with(['bookcategories' => function($q){
            $q ->join('categories', 'categories.id', '=', 'bookcategories.categorie_id')
            -> select('categories.name','bookcategories.book_id');
        }])->get();
        //select('id','name','picture','price')->get();
